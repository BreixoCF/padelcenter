...
emparejamientos automáticos. El código fuente completo del proyecto está disponible
públicamente en el repositorio de GitHub~\cite{padelcenterRepo}.
...
\begin{description}
  ...
  \item[Capítulo~\ref{chap:metodologia} — Metodología y planificación:] Se
    describe la metodología de desarrollo adoptada, el plan de trabajo inicial,
    los riesgos identificados y un análisis de la ejecución real del proyecto
