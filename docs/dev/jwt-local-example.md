...
The application accepts JWTs signed with HMAC-SHA256 using the secret
configured in `application.yaml` (`app.jwt.secret`, overridable via the
`JWT_SECRET` environment variable).

Default secret: `padelcenter-dev-secret-key-change-in-production-min32chars!!`
...
4. Set the secret to: `padelcenter-dev-secret-key-change-in-production-min32chars!!`
...
SECRET="padelcenter-dev-secret-key-change-in-production-min32chars!!"
